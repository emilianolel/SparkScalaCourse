...
// Broadcast variables forward a Map into all executors
...
object PopularMoviesNicerDataset {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    // This is how to read files in Scala
  ...
  def main(args: Array[String]) {
    ...
    // Map is loaded up and sent to all executors
    ...
    // to retrieve the actual value of broadcasted Map we need to use .value().
    // Remember nameDict is the broadcasted Map
    ...
    // col() passes the values of the given column name
